...
export default function HomeDashboard({ navigation }) {
  ...
  const [achievements, setAchievements] = useState([
    { id: 1, name: 'Week Warrior', icon: 'trophy', unlocked: true },
    { id: 2, name: 'Chat Master', icon: 'chatbubbles', unlocked: true },
    { id: 3, name: 'Perfect Attendance', icon: 'calendar', unlocked: false },
  ]);
    ...
    return (
      <View style={[styles.loadingContainer, { backgroundColor: theme.colors.bg }]}>
        <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
          <ModernCard gradient gradientColors={['#6366F1', '#8B5CF6']} style={styles.loadingCard}>
